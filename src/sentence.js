...
function generateSentence(){
    ...
    for(let i = 0; i < sentenceNumber; i++){
        ...
        if(randomNumber == 1){
            sentence = "The " + getAdjective() + " " + word + " " + getVerb() + " the " + getNoun() + " because it " + getVerb() + ".";
        }
        else if(randomNumber == 2){
            sentence = "Have you noticed that " + word + " " + getVerb() + " the " + getAdjective() + " " + getVerb() + " every day?";
        }
        else if(randomNumber == 3){
            sentence = "One " + getAdjective() + " " + getNoun() + " " + getVerb() + " while the " + word + " " + getVerb() + ".";
        }
        else if(randomNumber == 4){
            sentence = "Consider the following: My " + getAdjective() + " " + word + " " + getVerb() + ", but your " + getAdjective() + " " + getNoun() + " " + getVerb() + ".";
        }
        else if(randomNumber == 5){
            sentence = "At school, the " + word + " always " + getVerb() + ", especially when the " + getAdjective() + " " + getNoun() + " is here.";
        }
