...
const action = ["jumps", "dances", "sleeps", "leaves", "codes", "listens", "screams", "settles", "explodes", "attends", "meddles", "exists", "disagrees", "breathes", "sparkles", "shops", "skis", "increases", "communicates", "sighs", "sails", "cheers", "offends", "hums", "lies", "apologizes", "applauds", "expands", "runs", "walks", "stays", "agrees"];
...
function generateSentence(){
    ...
    for(let i = 0; i < sentenceNumber; i++){
        ...
        if(randomNumber == 1){
            ...
            sentence = "One " + getAdjective() + " " + getNoun() + " " + getVerb() + " " + aTest(2) + " while the " + word + " " + getAction() + ".";
        }
            ...
            sentence = "The " + word + ", " + aTest(1) + " " + getNoun() + ", " + getAction() + " at every school dance.";
        }
