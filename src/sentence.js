...
const action = ["jumps", "dances", "sleeps", "leaves", "codes", "listens", "screams", "whips", "hits the woah", "dabs", "settles", "explodes", "attends", "meddles", "exists", "disagrees", "breathes", "sparkles", "shops", "skis", "increases", "communicates", "sighs", "sails", "cheers", "offends", "hums", "lies", "apologizes", "applauds", "expands", "runs", "walks", "stays", "agrees"];
